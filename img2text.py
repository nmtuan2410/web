...
from models.End_ExpansionNet_v2_v2_n import End_ExpansionNet_v2_v2_n
...
def create_description(img_path):
    ...
    model = End_ExpansionNet_v2_v2_n(swin_img_size=img_size, swin_patch_size=4, swin_in_chans=3,
