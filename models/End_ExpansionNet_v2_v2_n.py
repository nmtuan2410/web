...
from models.layers_v3 import EmbeddingLayer, DecoderLayer, EncoderLayer
...
class End_ExpansionNet_v2_v2_n(CaptioningModel):
    def __init__(self,
        ...
        super(End_ExpansionNet_v2_v2_n, self).__init__()
